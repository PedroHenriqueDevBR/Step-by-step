module.exports = app => {
    ...
    const save = (req, res) => {
        ...
        try {
            existsOrError(category.name, "'name' nao informado.")
        } catch(msg) {
    ...
    const remove = async (req, res) => {
        try {
            ...
            notExistsOrError(subCategory, 'categoria nao pode ser removida pois possui subcategorias.')
            ...
            existsOrError(rowsDeleted, 'categoria descrita nao foi encontrada.')
